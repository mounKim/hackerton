"""
Django settings for sanplayer project.
...
SECRET_KEY = 'django-insecure-3bu4e_+4sw&6sfs@yvdzd4$1q_%-0y+acb^sh3p!8%sl9gv-(j'
...
WSGI_APPLICATION = 'sanplayer.wsgi.application'
